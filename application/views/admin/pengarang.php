        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h3 class="h3 mb-4 text-gray-800">Data Daftar Pengarang</h3>
                    <?= $this->session->flashdata('alert'); ?>
                    <div class="row">
                        <div class="col-md-10">
                            <a href="<?= base_url() ?>admin/tambah_pengarang" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Pengarang</a>
                        </div>
                    </div>
                    <br>
                        ...
                        <tbody>
                            ...
                            foreach ($data as $row) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url() ?>admin/edit/<?= $row->id_pengarang; ?>" class="btn btn-success btn-xs">Edit</a>
                                        <a href="<?= base_url() ?>admin/hapuss/<?= $row->id_pengarang; ?>" class="btn btn-danger btn-xs" onclick="return confirm('Yakin mau menghapus ?');">Hapus</a>
                                    </td>
                                </tr>
                            <?php }
                            ?>
