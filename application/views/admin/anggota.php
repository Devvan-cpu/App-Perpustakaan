        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <a href="<?= base_url() ?>admin/tambah_anggota" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Anggota</a>
                        </div>
                    </div>
                    <br>
                    <!-- /.box-header -->
                            ...
                            <tbody>
                                ...
                                foreach ($data as $row) { ?>
                                    <tr>
                                        ...
                                        <td><?= $row->no_hp; ?></td>
                                        <td>
                                            <a href="<?= base_url() ?>admin/hapus/<?= $row->id_anggota; ?>" class="btn btn-danger btn-xs" onclick="return confirm('Yakin mau menghapus ?');">Hapus</a>
                                            <a href="<?= base_url() ?>admin/edit_anggota/<?= $row->id_anggota; ?>" class="btn btn-warning btn-xs">Edit</a>
                                        </td>
                                    </tr>
                                <?php }
                                ?>
