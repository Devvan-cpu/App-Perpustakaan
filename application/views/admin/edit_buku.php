        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-lg-10">
                        <form action="<?= base_url('admin/updateee') ?>" method="POST">
                                    ...
                                    <select name="id_pengarang" class="form-control select2">
                                        ...
                                        foreach ($pengarang as $row) {
                                            if ($data['id_pengarang'] == $row->id_pengarang) { ?>
                                                <option value="<?= $row->id_pengarang ?>" selected> <?= $row->name_pengarang; ?> </option>
                                            <?php } else { ?>
                                    ...
                                    <select name="id_penerbit" class="form-control select2">
                                        ...
                                        foreach ($penerbit as $row) {
                                            if ($data['id_penerbit'] == $row->id_penerbit) { ?>
                                                <option value="<?= $row->id_penerbit ?>" selected> <?= $row->name_penerbit; ?> </option>
                                            <?php } else { ?>
