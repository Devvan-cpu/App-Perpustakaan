        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h3 class="h3 mb-4 text-gray-800">Data Buku</h3>
                    <?= $this->session->flashdata('alert'); ?>
                    <div class="row">
                        <div class="col-md-10">
                            <a href="<?= base_url() ?>admin/tambah_buku" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Data Buku</a>
                        </div>
                    </div>
                    <br>
                        ...
                        <tbody>
                            ...
                            foreach ($data->result() as $row) { ?>
                                <tr>
                                    ...
                                    <td><?= $row->name_pengarang; ?></td>
                                    <td><?= $row->name_penerbit; ?></td>
                                    <td><?= $row->tahun_terbit; ?></td>
                                    <td><?= $row->jumlah; ?></td>
                                    <td>
                                        <a href="<?= base_url() ?>admin/edittt/<?= $row->id_buku; ?>" class="btn btn-success btn-xs">Edit</a>
                                        <a href="<?= base_url() ?>admin/hapussss/<?= $row->id_buku; ?>" class="btn btn-danger btn-xs" onclick="return confirm('Yakin mau menghapus ?');">Hapus</a>
                                    </td>
                                </tr>
                            <?php }
                            ?>
