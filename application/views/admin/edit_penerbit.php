        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-lg-10">
                        <form action="<?= base_url('admin/updatee') ?>" method="POST">
                            <div class="form-group row">
                                <label for="email" class="col-sm-2 col-form-label">Name Penerbit</label>
                                <div class="col-sm-10">
                                    <input type="text" name="name_penerbit" id="name_penerbit" value="<?= $data['name_penerbit']; ?>" class="form-control" placeholder="Name Pengarang" required>
                                </div>
                            </div>
                            <div class="box-footer">
                                <a href="<?= base_url() ?>admin/penerbit" class="btn btn-warning">Cancel</a>
