        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h3 class="h3 mb-4 text-gray-800">Form Tambah Pengarang</h3>
                    <div class="col-lg-10">
                        <form action="<?= base_url('admin/update') ?>" method="POST">
                            <div class="form-group row">
                                <label for="email" class="col-sm-2 col-form-label">Name Pengarang</label>
                                <div class="col-sm-10">
                                    <input type="text" name="name_pengarang" id="name_pengarang" value="<?= $data['name_pengarang']; ?>" class="form-control" placeholder="Name Pengarang" required>
                                </div>
                            </div>
                            <div class="box-footer">
                                <a href="<?= base_url() ?>admin/pengarang" class="btn btn-warning">Cancel</a>
